 ...
 */
const j = window, st = j.ShadowRoot && (j.ShadyCSS === void 0 || j.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, rt = Symbol(), nt = /* @__PURE__ */ new WeakMap();
let vt = class {
  constructor(t, e, o) {
...
const bt = (s) => new vt(typeof s == "string" ? s : s + "", void 0, rt), zt = (s, ...t) => {
 ...
 */
var V;
const q = window, lt = q.trustedTypes, Nt = lt ? lt.emptyScript : "", ht = q.reactiveElementPolyfillSupport, tt = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? Nt : null;
      break;
  ...
  return e;
} }, yt = (s, t) => t !== s && (t == t || s == s), Z = { attribute: !0, type: String, converter: tt, reflect: !1, hasChanged: yt };
let x = class extends HTMLElement {
  ...
  requestUpdate(t, e, o) {
    let r = !0;
    t !== void 0 && (((o = o || this.constructor.getPropertyOptions(t)).hasChanged || yt)(this[t], e) ? (this._$AL.has(t) || this._$AL.set(t, e), o.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, o))) : r = !1), !this.isUpdatePending && r && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
x.finalized = !0, x.elementProperties = /* @__PURE__ */ new Map(), x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, ht == null || ht({ ReactiveElement: x }), ((V = q.reactiveElementVersions) !== null && V !== void 0 ? V : q.reactiveElementVersions = []).push("1.6.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var F;
const I = window, A = I.trustedTypes, ct = A ? A.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, f = `lit$${(Math.random() + "").slice(9)}$`, _t = "?" + f, Ot = `<${_t}>`, S = document, P = (s = "") => S.createComment(s), N = (s) => s === null || typeof s != "object" && typeof s != "function", $t = Array.isArray, Mt = (s) => $t(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", T = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, dt = /-->/g, pt = />/g, b = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), mt = /'/g, ut = /"/g, xt = /^(?:script|style|textarea|title)$/i, Rt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), m = Rt(1), y = Symbol.for("lit-noChange"), c = Symbol.for("lit-nothing"), wt = /* @__PURE__ */ new WeakMap(), k = S.createTreeWalker(S, 129, null, !1), Ut = (s, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; u < l.length && (n.lastIndex = u, h = n.exec(l), h !== null); )
      u = n.lastIndex, n === T ? h[1] === "!--" ? n = dt : h[1] !== void 0 ? n = pt : h[2] !== void 0 ? (xt.test(h[2]) && (r = RegExp("</" + h[2], "g")), n = b) : h[3] !== void 0 && (n = b) : n === b ? h[0] === ">" ? (n = r ?? T, p = -1) : h[1] === void 0 ? p = -2 : (p = n.lastIndex - h[2].length, w = h[1], n = h[3] === void 0 ? b : h[3] === '"' ? ut : mt) : n === ut || n === mt ? n = b : n === dt || n === pt ? n = T : (n = b, r = void 0);
    const U = n === b && s[a + 1].startsWith("/>") ? " " : "";
    i += n === T ? l + Ot : p >= 0 ? (o.push(w), l.slice(0, p) + "$lit$" + l.slice(p) + f + U) : l + f + (p === -2 ? (o.push(void 0), a) : U);
  }
  const d = i + (s[e] || "<?>") + (t === 2 ? "</svg>" : "");
  if (!Array.isArray(s) || !s.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return [ct !== void 0 ? ct.createHTML(d) : d, o];
};
class O {
  constructor({ strings: t, _$litType$: e }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const d = t.length - 1, a = this.parts, [l, w] = Ut(t, e);
          ...
          for (const p of r.getAttributeNames())
            if (p.endsWith("$lit$") || p.startsWith(f)) {
              ...
              if (h.push(p), u !== void 0) {
                ...
                a.push({ type: 1, index: i, name: H[2], strings: U, ctor: H[1] === "." ? jt : H[1] === "?" ? It : H[1] === "@" ? Dt : L });
              } else
...
class Ht {
  ...
  v(t) {
    ...
    for (; l !== void 0; ) {
      if (d === l.index) {
        let w;
        l.type === 2 ? w = new M(n, n.nextSibling, this, t) : l.type === 1 ? w = new l.ctor(n, l.name, l.strings, this, t) : l.type === 6 && (w = new Bt(n, this, t)), this.u.push(w), l = r[++a];
      }
...
class M {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), N(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== y && this.g(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Mt(t) ? this.k(t) : this.g(t);
  }
  O(t, e = this._$AB) {
  ...
  $(t) {
    ...
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === i)
      ...
      const n = new Ht(i, this), d = n.v(this.options);
...
const gt = I.litHtmlPolyfillSupport;
gt == null || gt(O, M), ((F = I.litHtmlVersions) !== null && F !== void 0 ? F : I.litHtmlVersions = []).push("2.6.1");
const Lt = (s, t, e) => {
  var o, r;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Yt = (s, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(e) {
...
var Qt = Object.defineProperty, Vt = Object.getOwnPropertyDescriptor, kt = (s, t, e, o) => {
  for (var r = o > 1 ? void 0 : o ? Vt(t, e) : t, i = s.length - 1, n; i >= 0; i--)
    (n = s[i]) && (r = (o ? n(t, e, r) : n(r)) || r);
  return o && r && Qt(t, e, r), r;
};
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xt = (s) => s.strings === void 0;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const At = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, St = (s) => (...t) => ({ _$litDirective$: s, values: t });
class Et {
  constructor(t) {
  }
  get _$AU() {
...
function Jt(s) {
  this._$AN !== void 0 ? (D(this), this._$AM = s, Ct(this)) : this._$AM = s;
}
function Kt(s, t = !1, e = 0) {
...
const Gt = (s) => {
  var t, e, o, r;
  s.type == At.CHILD && ((t = (o = s)._$AP) !== null && t !== void 0 || (o._$AP = Kt), (e = (r = s)._$AQ) !== null && e !== void 0 || (r._$AQ = Jt));
};
class te extends Et {
  constructor() {
  ...
  _$AT(t, e, o) {
    super._$AT(t, e, o), Ct(this), this.isConnected = t._$AU;
  }
  _$AO(t, e = !0) {
    var o, r;
...
const K = /* @__PURE__ */ new WeakMap(), se = St(class extends te {
  render(s) {
    return c;
  }
  update(s, [t]) {
...
var re = Object.defineProperty, ie = Object.getOwnPropertyDescriptor, Tt = (s, t, e, o) => {
...
let B = class extends v {
  constructor() {
    super(...arguments), this.open = !1, this.contentRef = ee();
  }
  _updateContentStyle() {
  ...
  render() {
    return m`
            <div class="group" @toggle-open="${this._onToggleOpenEvent}">
                <slot></slot>
                <div class="overflow-hidden transition-all duration-500" ${se(this.contentRef)}>
...
class ot extends Et {
  constructor(t) {
    if (super(t), this.it = c, t.type !== At.CHILD)
...
var he = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, $ = (s, t, e, o) => {
  for (var r = o > 1 ? void 0 : o ? ce(t, e) : t, i = s.length - 1, n; i >= 0; i--)
    (n = s[i]) && (r = (o ? n(t, e, r) : n(r)) || r);
...
let g = class extends v {
  ...
  _loadStatus() {
    const s = le(this.cookieName);
    this._status = s ? JSON.parse(s) : void 0, this._emitStatusChange();
  }
  _saveStatus() {
    ae(this.cookieName, JSON.stringify(this._status), 365), this._emitStatusChange();
  }
  _emitStatusChange() {
    var s, t, e, o, r;
    this.dispatchEvent(
  ...
  informationTab() {
    return this._config ? (console.log(this._config.texts.information_text), m` <div class="prose prose-sm">${ne(this._config.texts.information_text)}</div> `) : null;
  }
  modalToggle() {
    return m`
...
const de = document.createElement("cookie-solution-banner");
